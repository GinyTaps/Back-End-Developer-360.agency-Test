package com.agency.listingcar.web.rest.util;
...
public class HeaderUtil {
    ...
    public static HttpHeaders createEntityPublishedAlert(String entityName, String param) {
        return createAlert(APPLICATION_NAME + "." + entityName + ".published", param);
    }
    
    public static HttpHeaders createEntityUnpublishedAlert(String entityName, String param) {
        return createAlert(APPLICATION_NAME + "." + entityName + ".unpublished", param);
    }
